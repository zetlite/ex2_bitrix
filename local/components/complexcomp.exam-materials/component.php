...
$arDefaultUrlTemplates404 = [
    ...
    "exampage2" => "#SECTION_ID#/#ELEMENT_ID#/#PARAM3#/?PARAM4=#PARAM4#",
    "exampage3" => "#SECTION_ID#/#ELEMENT_ID#/?edit=#PARAM5#",
];
...
if ($arParams["SEF_MODE"] == "Y") {
    ...
    if (isset($arVariables["PARAM3"]) && strlen($arVariables["PARAM3"]) > 0
        && isset($arVariables["ELEMENT_ID"]) && intval($arVariables["ELEMENT_ID"])
        && isset($arVariables["SECTION_ID"]) && intval($arVariables["SECTION_ID"]) > 0)
        $componentPage = "exampage2";
    elseif (isset($arVariables["PARAM5"]) && intval($arVariables["PARAM5"]) > 0
        && isset($arVariables["ELEMENT_ID"]) && intval($arVariables["ELEMENT_ID"])
        && isset($arVariables["SECTION_ID"]) && intval($arVariables["SECTION_ID"]) > 0)
        $componentPage = "exampage3";
    ...
    $arResult = [
        ...
        "URL_TEMPLATES" => [
            ...
            "exampage2" => htmlspecialcharsbx(
                $APPLICATION->GetCurPage()) . "?" .
                $arVariableAliases["SECTION_ID"] . "=#SECTION_ID#" . "&" .
                $arVariableAliases["ELEMENT_ID"] . "=#ELEMENT_ID#" . "&" .
                $arVariableAliases["PARAM3"] . "=#PARAM3#" . '&' .
                $arVariableAliases["PARAM4"] . "=#PARAM4#"
            ,
            "exampage3" => htmlspecialcharsbx(
                $APPLICATION->GetCurPage()) . "?" .
                $arVariableAliases["SECTION_ID"] . "=#SECTION_ID#" . "&" .
                $arVariableAliases["ELEMENT_ID"] . "=#ELEMENT_ID#" . "&" .
                $arVariableAliases["PARAM5"] . "=#PARAM5#"
            ,
        ],
        "VARIABLES" => $arVariables,
        "ALIASES" => $arVariableAliases,
